...
namespace QLicense.Windows.Controls
{
    public partial class LicenseActivateControl : UserControl
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(txtLicense.Text.Trim()))
            {
            ...
            LicenseEntity _lic = LicenseHandler.ParseLicenseFromBASE64String(LicenseObjectType, txtLicense.Text.Trim(), 
        ...
        private void rbtnLicenseTypes_SelectedIndexChanged(object sender, EventArgs e)
        {
            RadioGroup edit = sender as RadioGroup;

            int editGrp = edit.SelectedIndex;
            switch(editGrp)
            {
                //Basic
                case 0:
