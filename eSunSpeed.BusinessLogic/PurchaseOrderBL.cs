...
namespace eSunSpeed.BusinessLogic
{
    public class PurchaseOrderBL
    {
        ...
        public bool SavePurchaseOrderItems(List<Item_VoucherModel> lstSPurcItems, int ParentId)
        {
            string Query = string.Empty;
            bool isSaved = true;

            //objItem.ParentId = GetPurchaseVoucherId();
            foreach (Item_VoucherModel item in lstSPurcItems)
            {
                ...
                try
                {
                    ...
                    paramCollection.Add(new DBParameter("@Trans_Purcord_Id", item.ParentId));
                    ...
                    System.Data.IDataReader dr =
                   _dbHelper.ExecuteDataReader("spInsertPurcOrderItem", _dbHelper.GetConnObject(), paramCollection, System.Data.CommandType.StoredProcedure);
        ...
        public bool SavePurchaseOrderBillSundryVoucher(List<BillSundry_VoucherModel> lstpurcBS, int ParentId)
        {
            string Query = string.Empty;
            bool isSaved = true;
            ...
            foreach (BillSundry_VoucherModel bs in lstpurcBS)
            {
                ...
                try
                {
                    ...
                    paramCollection.Add(new DBParameter("@Trans_Purcord_Id", bs.ParentId));
                    ...
                    System.Data.IDataReader dr =
                    _dbHelper.ExecuteDataReader("spPurOrdertBillSundry", _dbHelper.GetConnObject(), paramCollection, System.Data.CommandType.StoredProcedure);
