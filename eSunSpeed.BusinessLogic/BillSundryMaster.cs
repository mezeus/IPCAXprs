   ...
   public class BillSundryMaster
    {
        ...
        public bool SaveBSM(eSunSpeedDomain.BillSundryMasterModel objBSM)
        {
            ...
            try
            {
                ...
                Query = "INSERT INTO billsundrymaster(`Name`,`Alias`,`PrintName`,`BillSundryType`,`BillSundryNature`,`DefaultValue`,`subtotalheading`," +
        ...
        public List<BillSundryMasterModel> GetAllBillSundry()
        {
            ...
            while (dr.Read())
            {
                ...
                //objBsm.SaleAffectsAccounting = Convert.ToBoolean(dr["AffectsAccounting"]);
