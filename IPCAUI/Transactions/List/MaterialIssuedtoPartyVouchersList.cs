...
{
    public partial class MaterialIssuedtoPartyVouchers : Form
    {
        AccountMasterBL objaccbl = new AccountMasterBL();
        public MaterialIssuedtoPartyVouchers()
        {
          
            InitializeComponent();
        }

        private void MaterialIssuedtoPartyVouchers_Load(object sender, EventArgs e)
        {
