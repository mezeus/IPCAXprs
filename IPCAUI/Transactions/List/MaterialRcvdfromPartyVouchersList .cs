...
{
    public partial class MaterialReceivedfromPartyVouchers : Form
    {
        AccountMasterBL objaccbl = new AccountMasterBL();
        public MaterialReceivedfromPartyVouchers()
        {
          
            InitializeComponent();
        }

        private void MaterialReceivedfromPartyVouchers_Load(object sender, EventArgs e)
        {
