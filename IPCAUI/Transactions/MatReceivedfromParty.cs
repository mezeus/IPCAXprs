...
{
    public partial class Matreceivedfromparty : Form
    {
        eSunSpeed.BusinessLogic.MatRcvdPartyBL objMRBL = new MatRcvdPartyBL();
        public Matreceivedfromparty()
        {
            InitializeComponent();
        }
        ...
        private void Matreceivedfromparty_Load(object sender, EventArgs e)
        {
