...
{
    public partial class Unassemblevoucher : Form
    {
        eSunSpeed.BusinessLogic.UnassembleVoucherBL objUABL = new UnassembleVoucherBL();
        public Unassemblevoucher()
        {
            InitializeComponent();
        }
        ...
        private void Unassemblevoucher_Load(object sender, EventArgs e)
        {
        ...
        private void gdvMainItemIg_Click(object sender, EventArgs e)
        {
        ...
        {
            eSunSpeedDomain.UnassembleVoucherModel objProdu = new eSunSpeedDomain.UnassembleVoucherModel();
            ...
            objProdu.UA_Date = Convert.ToDateTime(dtDate.Text);
            objProdu.Voucher_Number = Convert.ToInt32(tbxVoucherNo.Text.Trim());
            objProdu.BOM_Name = tbxBOMName.Text.Trim();
            ...
            bool isSuccess = objUABL.SaveUnassembleVoucher(objProdu);
            if (isSuccess)
            {
